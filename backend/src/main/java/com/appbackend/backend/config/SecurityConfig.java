...
import com.appbackend.backend.security.JwtAuthenticationFilter;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers("/auth/administration/**").permitAll()
                        ...
                        .requestMatchers("/api/categories/**").hasAnyRole("ADMIN", "OPERATOR", "USER")
                        .requestMatchers("/api/subcategories/**").hasAnyRole("ADMIN", "OPERATOR", "USER")
